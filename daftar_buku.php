...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="logo_rs.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="card-body">
            ...
            <tr>
                ...
                <td>
                  ...
                  <a href="hapus.php?id_perpustakaan=<?=$data['id_perpustakaan']. "onClick=\"return confirm('Are you sure want to delete?')";?>">
                    <input type="button" class="btn btn-primary btn-sm" value='Hapus'></a>
                </td>
            </tr>
            <?php
        };
